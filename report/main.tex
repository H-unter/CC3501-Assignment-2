...
\begin{document}
    ...
    \input{sec1_intro}
    \input{sec2_overview}
    \input{sec2.1_hardware_design}
    \input{sec2.2_comm_protocols}
    \input{sec2.3_user_interface}
    \input{sec3.1_challenges}
    \input{sec3.2_discussion}
    \input{sec3.3_recommendations}
